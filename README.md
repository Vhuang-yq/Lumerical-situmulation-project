...
输入光通过 Mode Source 激励后：

1. 在 Y-splitter 处分成两路
2. 分别在两条干涉臂中传播
3. 最终在 Y-combiner 中重新叠加
4. 输出端形成干涉结果
...
![MZI Structure](./figures/mzi_structure.png)
...
![Transmission Spectrum](./figures/transmission.png)
